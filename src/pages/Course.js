...
import { Rating, Button, Divider, useMediaQuery, Tabs, Tab } from "@mui/material";
...
function Course() {
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        LoaderUtils.open()
        const course = window.location.pathname.split("/")[2].toString()
        bring({path: '/getCourse/' + course + '?learn=true' })
            .then(data => {
                setTimeout(() => LoaderUtils.close(), 500)
        ...
        <div>
            {courseDetails.learn ? (
                <>
                    <section>
                        <div
                            style={{
                                ...
                                paddingBottom: courseDetails.learn ? "0" : "24px",
                            }}
                        >
                            <div
                                style={
                            ...
                            >
                                ...
                                {courseDetails.chapters.map((chapter, index) => <Tab value={chapter} key={index} label={"Chapter " + (index + 1)} />)}
                            </Tabs>
                        </div>
                    </section>
                    { tab === "overview" ? 
                    ...
                    :
                    <Chapter course={courseDetails._id} chapter={tab} /> }
                </>
            ) : (
                <section
                    style={{
